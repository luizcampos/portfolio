...
var projects = {
    title: ['Palette Generator', 'Ignite Lab', 'Quiz HP', 'Calculator', 'API Restful myDreamBox', 'Fazendo Arte'],
    imageTop: [
    ...
    status: ['em andamento', 'finalizado', 'finalizado', 'em andamento', 'finalizado', 'finalizado'],
    about: [
